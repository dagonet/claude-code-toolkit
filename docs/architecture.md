...
| `PROJECT_CONTEXT.md` | 946 | 946 | 946 | 946 | 3,170 | **3,422** | every session |
...
| **always-loaded total** | **41,167** | 32,538 | 25,814 | 25,999 | 23,044 | **15,725 (−62%)** | |
