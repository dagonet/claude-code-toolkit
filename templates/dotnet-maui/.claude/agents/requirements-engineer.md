...
1. **Feature Specification**: Take a feature idea or rough description and produce a complete spec containing:
   ...
   - **UI/UX Notes**: Screens affected, navigation flow, key interactions (XAML views, MVVM bindings)
...
- **UI Framework**: .NET MAUI with MVVM (CommunityToolkit.MVVM)
- **Testing**: BDD with Reqnroll, unit tests with xUnit + FluentAssertions + NSubstitute
- **Patterns**: Repository pattern, DI via Microsoft.Extensions.DependencyInjection, RelayCommand / AsyncRelayCommand
