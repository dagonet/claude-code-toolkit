...
Coder B's skill-side items ship in the same release: B1 (MM-Agent), B2/B5 (panoscribe), B3/B4 (yutraffic), B6/B7 (open-brain) — see `user-level-reference/skills/sync-template/**` and `docs/verification.md` for their detail.
